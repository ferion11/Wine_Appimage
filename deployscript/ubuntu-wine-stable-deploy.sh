...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-stable_4.3~bionic_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-stable-i386_4.3~bionic_i386.deb

dpkg -x wine-stable_4.3~bionic_i386.deb wineversion/
dpkg -x wine-stable-i386_4.3~bionic_i386.deb wineversion/
...
aptitude -y -d -o dir::cache::archives="$pkgcachedir" install libwine:i386 libva2:i386 libva-drm2:i386 libva-x11-2:i386 libvulkan1:i386 winbind:i386
