...
pacman -Syw  --noconfirm --cachedir cache lib32-fontconfig lib32-gst-plugins-base-libs lib32-mpg123 lib32-vulkan-intel lib32-vulkan-radeon lib32-vulkan-icd-loader $dependencys
