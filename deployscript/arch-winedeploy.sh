...
export ARCH=x86_64; squashfs-root/AppRun -v $wineworkdir -u 'gh-releases-zsync|mmtrt|Wine_Appimage|continuous|Wine*arch*.AppImage.zsync' Wine-i386-${ARCH}-arch.latest.AppImage
