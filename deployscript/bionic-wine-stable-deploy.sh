...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-amd64/wine-stable_4.0.1~bionic_amd64.deb
...
aptitude -y -d -o dir::cache::archives="$pkgcachedir" install libwine libwine:i386 libva2:i386 libva-drm2:i386 libva-x11-2:i386 libavcodec57:i386
...
export ARCH=x86_64; squashfs-root/AppRun -v $wineworkdir -u 'gh-releases-zsync|ferion11|Wine_Appimage|continuous|wine-stable*bionic.AppImage.zsync' wine-stable-i386_${ARCH}-bionic.AppImage