...
aptitude -y -d -o dir::cache::archives="$pkgcachedir" install winehq-stable libalsaplayer0 libalsaplayer0:i386 libwine:i386 libva2:i386 libva-drm2:i386 libva-x11-2:i386 libvulkan1:i386 libavcodec57:i386
