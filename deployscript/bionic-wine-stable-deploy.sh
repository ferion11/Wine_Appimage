...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-stable_${WS_VER}~bionic_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/ubuntu/dists/bionic/main/binary-i386/wine-stable-i386_${WS_VER}~bionic_i386.deb

dpkg -x wine-stable_${WS_VER}~bionic_i386.deb wineversion/
dpkg -x wine-stable-i386_${WS_VER}~bionic_i386.deb wineversion/
