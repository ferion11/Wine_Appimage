...
# Remove non lib32 pkgs before extracting (small zsnes 1.51 for easter egg)
mv ./cache/zsnes* ./
...
# lib32-gst-libav lib32-libwbclient lib32-tevent lib32-talloc lib32-ldb lib32-libbsd lib32-avahi lib32-libarchive lib32-smbclient
