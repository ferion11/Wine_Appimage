...
export ARCH=x86_64; squashfs-root/AppRun -v $wineworkdir -u 'gh-releases-zsync|mmtrt|Wine_Appimage|continuous|Wine-devel*bionic.AppImage.zsync' Wine-devel-i386-${ARCH}-bionic.AppImage
