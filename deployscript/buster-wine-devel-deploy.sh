...
# Get Wine
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-devel_4.8~buster_i386.deb
wget -nv -c https://dl.winehq.org/wine-builds/debian/dists/buster/main/binary-i386/wine-devel-i386_4.8~buster_i386.deb

dpkg -x wine-devel_4.8~buster_i386.deb wineversion/
dpkg -x wine-devel-i386_4.8~buster_i386.deb wineversion/
...
export ARCH=x86_64; squashfs-root/AppRun -v $wineworkdir -u 'gh-releases-zsync|mmtrt|Wine_Appimage|continuous|wine-devel*buster.AppImage.zsync' wine-devel-i386_${ARCH}-buster.AppImage