...
export ARCH=x86_64; squashfs-root/AppRun -v $wineworkdir -u 'gh-releases-zsync|mmtrt|Wine_Appimage|continuous|Wine-staging*bionic.AppImage.zsync' Wine-staging-i386-${ARCH}-bionic.AppImage