...
dpkg -x wine-stable_4.0.1~stretch_i386.deb wineversion/
dpkg -x wine-stable-i386_4.0.1~stretch_i386.deb wineversion/
...
export ARCH=x86_64; squashfs-root/AppRun -v $wineworkdir -u 'gh-releases-zsync|mmtrt|Wine_Appimage|continuous|wine-stable*stretch.AppImage.zsync' wine-stable-i386_${ARCH}-stretch.AppImage